...
int main(int argc, char *argv[]) {
    ...
    // creates layout for stop, play and stop button
    QHBoxLayout* playback = new QHBoxLayout;
    //creating pause button
    QPushButton *pauseButton = new QPushButton();
    pauseButton -> setText("Pause"); //creating text for the button
    pauseButton->connect(pauseButton, SIGNAL(clicked()), player, SLOT (toPause()));
    playback->addWidget(pauseButton);
    //creating play button
    QPushButton *playButton = new QPushButton();
    playButton -> setText("Play"); //creating text for the button
    ...
    top->addLayout(playback); // adds layout for stop, play and stop button
